 ...
 *
 * Formation data and templates are in formation-data.ts
 */

import type { AdvancedCombatUnit, UnitClass } from './advanced-unit'
import type { DamageTypes } from './damage-types'

// Import and re-export formation data from dedicated module
import { DEFAULT_FORMATION_BONUSES, FORMATIONS, getFormationTypes, getFormation, isValidFormationType } from './formation-data'
export { DEFAULT_FORMATION_BONUSES, FORMATIONS, getFormationTypes, getFormation, isValidFormationType }
